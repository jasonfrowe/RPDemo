...
TRACKS: list = [
    TrackSpec(
        ...
        aliases=["title"],
        mood=MoodPreset(key_root=0, scale="major", bpm=116, intensity=0.10, lead_octave=5),
    ),
    TrackSpec(
        resource="RESOURCE.005",
        description="Level 1 & 5",
        aliases=["level1", "level5"],
        mood=MoodPreset(key_root=9, scale="mixolydian", bpm=124, intensity=0.20, lead_octave=5),
    ),
    TrackSpec(
        resource="RESOURCE.003",
        description="Level 2 & 6",
        aliases=["level2", "level6"],
        mood=MoodPreset(key_root=2, scale="dorian", bpm=120, intensity=0.35, lead_octave=5),
    ),
    TrackSpec(
        resource="RESOURCE.008",
        description="Level 3",
        aliases=["level3"],
        mood=MoodPreset(key_root=7, scale="mixolydian", bpm=126, intensity=0.40, lead_octave=5),
    ),
    TrackSpec(
        resource="RESOURCE.002",
        description="Level 4",
        aliases=["level4"],
        mood=MoodPreset(key_root=4, scale="phrygian", bpm=118, intensity=0.50, lead_octave=4),
    ),
    TrackSpec(
        resource="RESOURCE.010",
        description="Level 7 (late-game)",
        aliases=["level7"],
        mood=MoodPreset(key_root=11, scale="minor", bpm=128, intensity=0.75, lead_octave=5),
    ),
    TrackSpec(
        resource="RESOURCE.009",
        description="Boss stage (also level 8+ fallback)",
        aliases=["boss"],
        mood=MoodPreset(key_root=9, scale="minor", bpm=132, intensity=0.95, lead_octave=4, arp_octave=3),
    ),
    TrackSpec(
        resource="RESOURCE.006",
        description="Bonus / reward round",
        aliases=["bonus", "reward"],
        mood=MoodPreset(key_root=5, scale="major", bpm=120, intensity=0.15, lead_octave=5),
    ),
    TrackSpec(
        resource="RESOURCE.011",
        description="Game over (win or lose)",
        aliases=["gameover"],
        mood=MoodPreset(key_root=2, scale="minor", bpm=96, intensity=0.55, target_seconds=80.0,
